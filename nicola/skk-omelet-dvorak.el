;;; skk-omelet-dvorak.el --- SKK に omelet (Dvorak) 入力環境を提供 -*- coding: utf-8 -*-
...
これに基いて以下の 3 つのルールが決定されます。
 ...
 `skk-omelet-dvorak-plain-rule-list'
 `skk-omelet-dvorak-lshift-rule-list'
 `skk-omelet-dvorak-rshift-rule-list'
