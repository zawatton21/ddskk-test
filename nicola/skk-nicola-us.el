;;; skk-nicola-us.el --- SKK に NICOLA (US) 入力環境を提供 -*- coding: utf-8 -*-
...
;; このファイルは NICOLA 規格準拠 US 配列とそれを実現するためのルールを提供し
;; ます。
...
(defconst skk-nicola-us-keymap-display 'dummy "\
以下は、US 101 キーボードで NICOLA 入力するためのキー配列図です。
...
これに基いて以下の 3 つのルールが決定されます。
 ...
 `skk-nicola-us-plain-rule-list'
 `skk-nicola-us-lshift-rule-list'
 `skk-nicola-us-rshift-rule-list'
